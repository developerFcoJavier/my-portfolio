export const Projects = [
    {
        name: 'ADUNA',
        path: '/aduna',
        tooltip: `This was a personal project in which I developed a System that managed the sale and loading of water to transport trucks.
    ...
    },  
    {
        name: 'VISITOR SYSTEM',
        path: '/python',
        tooltip: `This System records the information of visitors who come to a specific site. The information is 
    ...
    },  
    {
        ...
        path: '/python',
        tooltip: `This System is in charge of digitizing the lower part of cars of all kinds at a certain 
    ...
    },
    {
        ...
        path: '/python',
        tooltip: `The main objective of this System is to schedule an appointment for a guest from your space in 
