    ...
    return (
        <>
            <div className="title">
                ...
                <h4 style={{marginTop: "-26px"}}> Full Stack Developer</h4>
            </div>
            <div className="container">
                <div className="developer">
                    ...
                    <div className="contact">
                        <h4>Get in touch</h4>
                        <li>Email: <a href = "mailto: developer.fjoh@gmail.com?subject = Feedback & body = Message">developer.fjoh@gmail.com</a></li>
                        <li>Phone: +52 5588359277</li>
                    </div>
                    <div className="social">
                        <h4>Social Media</h4>
                        <li>
                            <a href="https://developerfcojavier.github.io/my-portfolio/">
                                <DiGithubBadge size="30" color="white" />
                            </a>&nbsp;
                            <a href="https://www.linkedin.com/in/developerfcojavier/"><BsLinkedin size="20" color="white"/></a>
                        </li>
                    </div>
